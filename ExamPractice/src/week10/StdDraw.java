...
/**
 *  The {@code week10.StdDraw} class provides a basic capability for
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code week10.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">week10.StdDraw.java</a>
 ...
 *           week10.StdDraw.setPenRadius(0.05);
 *           week10.StdDraw.setPenColor(week10.StdDraw.BLUE);
 *           week10.StdDraw.point(0.5, 0.5);
 *           week10.StdDraw.setPenColor(week10.StdDraw.MAGENTA);
 *           week10.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code week10.StdDraw.line()} and {@code week10.StdDraw.point()}
 *  draw lines and points; the methods {@code week10.StdDraw.setPenRadius()}
 *  and {@code week10.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code week10.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   week10.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code week10.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code week10.StdDraw.setPenColor(week10.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code week10.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code week10.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   week10.StdDraw.setFont(font);
 *   week10.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code week10.StdDraw.clear(week10.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   week10.StdDraw.setScale(-2, +2);
 *   week10.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       week10.StdDraw.clear();
 *       week10.StdDraw.filledCircle(x, y, 0.05);
 *       week10.StdDraw.filledCircle(-x, -y, 0.05);
 *       week10.StdDraw.show();
 *       week10.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code week10.StdDraw.BLACK}, {@code week10.StdDraw.BLUE}, {@code week10.StdDraw.CYAN},
     * {@code week10.StdDraw.DARK_GRAY}, {@code week10.StdDraw.GRAY}, {@code week10.StdDraw.GREEN},
     * {@code week10.StdDraw.LIGHT_GRAY}, {@code week10.StdDraw.MAGENTA}, {@code week10.StdDraw.ORANGE},
     * {@code week10.StdDraw.PINK}, {@code week10.StdDraw.RED}, {@code week10.StdDraw.WHITE}, and
     * {@code week10.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to week10.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
    ...
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to week10.StdDraw)
        try {
            URL url = week10.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
