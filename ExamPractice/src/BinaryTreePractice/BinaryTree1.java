...
public class BinaryTree1<T> implements BinaryTree<T>, Serializable{
    ...
    private class InOrderIeterator implements Iterator<T> {
        ...
        public boolean hasNext() {
            if(!isValid()) {throw new RuntimeException("In valid iterator - The BinaryTreePractice.BinaryTree was changed sience the iterator was constructed");}
            return _ind < size();
        }
    ...
    public T remove(T t) {
        ...
        //	ArrayList<T> tt = BinaryTreePractice.BinaryTreeAlgo.toArrayList(this);
